...
read_vhdl -vhdl2008 [glob -join -dir $srcDir * *.vhd]
read_vhdl -vhdl2008 [glob -join -dir $srcDir * * *.vhd]
read_vhdl -vhdl2008 [glob -join -dir $srcDir test_files hdl *.vhd]

read_vhdl -vhdl2008 [glob -join -dir $testDir * *.vhd]

read_vhdl -vhdl2008 [glob -join -dir $topDir *.vhd]
